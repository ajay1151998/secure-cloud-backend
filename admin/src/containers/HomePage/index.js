            ...
            <Block>
              ...
              {hasAlreadyCreatedContentTypes ? (
                <FormattedMessage id="app.components.HomePage.welcomeBlock.content.again">
                  {/* {msg => <P>{msg}</P>} */}
                  <P>We hope you are making progress on your project... Feel free to read the latest news. We are giving our best to improve the product based on your feedback.</P>
                </FormattedMessage>
              ) : (
